 ...
 * Verifica se o parâmetro é um número e então compara se o resultado da conversão para
 * inteiro é identico ao original. Caso seja diferente, o valor não era um inteiro
 */
 ...
 * Verifica se o parâmetro é um número e então compara se o resultado da conversão para
 * float é identico ao original. Caso seja diferente, o valor não era um float
 */
 ...
 * Verifica se a divisão da string pela barra resulta em três fragmentos
 * para então instanciar um objeto de data com o padrão americano MM/DD/YYYY
 * Como o javascript é muito flexível na hora de aceitar data inválidas, convertendo
 * para datas válidas, é realizada uma verificação se os dados resultantes são os mesmos
 * do parâmetro recebido. Caso seja diferente, o valor não era uma data
 */
 ...
 * segmentos são compostos somente de números
 ...
 * Os três primeiros caracteres devem ser não numéricos
 ...
 * separados em nome;tipo;nãonulo;funcaoAdicional
 */
